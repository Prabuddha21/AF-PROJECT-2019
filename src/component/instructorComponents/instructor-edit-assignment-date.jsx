...
export default class EditAssignmentDate extends Component {
  ...
  componentDidMount() {
    ...
    axio
      .get(
        "http://localhost:3000/courseweb/assignments/update/" +
  ...
  onSubmit(e) {
    ...
    if (newDueDate < originalDueDate) {
      ...
      axio
        .post(
          "http://localhost:3000/courseweb/assignments/update/date/" +
            this.props.match.params.assignmentID,
          obj
        )
        .then(res => {
  ...
  render() {
    return (
      <div className="container">
        ...
        <h1>Edit Assignment Date of "{this.state.assignmentName}" Assignment</h1>
        <br />
